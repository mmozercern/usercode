...
process.TagProbeFitTreeAnalyzerSel = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
                                                   ...
                                                   OutputFileName = cms.string("3deff_finalPU_sel.root"),
                                                   ...
                                                   Variables = cms.PSet( mass = cms.vstring("Tag-Probe Mass", "70.0", "120.0", "GeV/c^{2}"),
                                                                         ...
                                                                         npf15PU = cms.vstring("N_{PFjet} (15)", "-0.5", "10.5", ""),
                                                                         npf30PU = cms.vstring("N_{PFjet} (30)", "-0.5", "10.5", "")
                                                                         ),
                                                   ...
                                                   Efficiencies = cms.PSet( pt_eta_80_0PU30 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                         UnbinnedVariables = cms.vstring("mass"),
                                                                                         BinnedVariables = cms.PSet(pt = cms.vdouble(20,30,40,50,100),
                                                                                                                    abseta = cms.vdouble(0,0.5,1.0,1.4442,1.566,2.0,2.5),
                                                                                                                    npf30PU  = cms.vdouble(-0.5,0.5)
                                                                                                                    ),
                                                                                         BinToPDFmap = cms.vstring("gaussPlusLinear0SemiFix80")
                                                                                         ),
                                                                            pt_eta_80_1PU30 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                         UnbinnedVariables = cms.vstring("mass"),
                                                                                         BinnedVariables = cms.PSet(pt = cms.vdouble(20,30,40,50,100),
                                                                                                                    abseta = cms.vdouble(0,0.5,1.0,1.4442,1.566,2.0,2.5),
                                                                                                                    npf30PU  = cms.vdouble(0.5,1.5)
                                                                                                                    ),
                                                                                         BinToPDFmap = cms.vstring("gaussPlusLinear1SemiFix80")
                                                                                         ),
                                                                            pt_eta_80_1PU30_coarse = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                         UnbinnedVariables = cms.vstring("mass"),
                                                                                         BinnedVariables = cms.PSet(pt = cms.vdouble(20,40,100),
                                                                                                                    abseta = cms.vdouble(1.566,2.0,2.5),
                                                                                                                    npf30PU  = cms.vdouble(0.5,1.5)
                                                                                                                    ),
                                                                                         BinToPDFmap = cms.vstring("gaussPlusLinear1SemiFix80")
                                                                                         ),
                                                                            pt_eta_95_0PU30 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                         UnbinnedVariables = cms.vstring("mass"),
                                                                            ...
                                                                            pt_eta_95_1PU30 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                                   UnbinnedVariables = cms.vstring("mass"),
                                                                                                   BinnedVariables = cms.PSet(pt = cms.vdouble(10,30,40,50,100),
                                                                                                                              abseta = cms.vdouble(0,0.5,1.0,1.4442,1.566,2.0,2.5),
                                                                                                                              npf30PU  = cms.vdouble(0.5,1.5)
                                                                            ...
                                                                            pt_eta_95_1PU30_coarse = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                                          UnbinnedVariables = cms.vstring("mass"),
                                                                                         BinnedVariables = cms.PSet(pt = cms.vdouble(10,30),
                                                                            ...
                                                                            pt_eta_80_0PU15 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                         UnbinnedVariables = cms.vstring("mass"),
                                                                                         BinnedVariables = cms.PSet(pt = cms.vdouble(20,30,40,50,100),
                                                                                                                    abseta = cms.vdouble(0,0.5,1.0,1.4442,1.566,2.0,2.5),
                                                                                                                    npf15PU  = cms.vdouble(-0.5,0.5)
                                                                                                                    ),
                                                                                         BinToPDFmap = cms.vstring("gaussPlusLinear0SemiFix80")
                                                                                         ),
                                                                            pt_eta_80_1PU15 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                         UnbinnedVariables = cms.vstring("mass"),
                                                                                         BinnedVariables = cms.PSet(pt = cms.vdouble(20,30,40,50,100),
                                                                                                                    abseta = cms.vdouble(0,0.5,1.0,1.4442,1.566,2.0,2.5),
                                                                                                                    npf15PU  = cms.vdouble(0.5,1.5)
                                                                                                                    ),
                                                                                         BinToPDFmap = cms.vstring("gaussPlusLinear1SemiFix80")
                                                                                         ),
                                                                            pt_eta_95_0PU15 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                         UnbinnedVariables = cms.vstring("mass"),
                                                                                         BinnedVariables = cms.PSet(pt = cms.vdouble(10,30,40,50,100),
                                                                                                                    abseta = cms.vdouble(0,0.5,1.0,1.4442,1.566,2.0,2.5),
                                                                                                                    npf15PU  = cms.vdouble(-0.5,0.5)
                                                                            ...
                                                                            pt_eta_95_1PU15 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                                   UnbinnedVariables = cms.vstring("mass"),
                                                                                                   BinnedVariables = cms.PSet(pt = cms.vdouble(10,30,40,50,100),
                                                                                                                              abseta = cms.vdouble(0,0.5,1.0,1.4442,1.566,2.0,2.5),
                                                                                                                              npf15PU  = cms.vdouble(0.5,1.5)
                                                                            ...
                                                                            npf30PU_wp95 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                                  UnbinnedVariables = cms.vstring("mass"),
                                                                                                  BinnedVariables = cms.PSet( npf30PU = cms.vdouble(-0.5,0.5,1.5),
                                                                                                                              ),
                                                                                                  BinToPDFmap = cms.vstring("gaussPlusLinear")
                                                                                                  ),
                                                                            npf30PU_wp95Fix = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                                     UnbinnedVariables = cms.vstring("mass"),
                                                                                                     BinnedVariables = cms.PSet( npf30PU = cms.vdouble(1.5,2.5,3.5,4.5),
                                                                                                                                 ),
                                                                                                     BinToPDFmap = cms.vstring("gaussPlusLinear1Fix95")
                                                                                                     ),
                                                                            npf30PU_wp80 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                                  UnbinnedVariables = cms.vstring("mass"),
                                                                                                  BinnedVariables = cms.PSet( npf30PU = cms.vdouble(-0.5,0.5,1.5),
                                                                            ...
                                                                            npf30PU_wp80Fix = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                                     UnbinnedVariables = cms.vstring("mass"),
                                                                                                     BinnedVariables = cms.PSet( npf30PU = cms.vdouble(1.5,2.5,3.5,4.5),
                                                                                                                                pt = cms.vdouble(20,100),
                                                                                                                                ),
                                                                            ...
                                                                            npf15PU_wp95 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP95","pass"),
                                                                                                  UnbinnedVariables = cms.vstring("mass"),
                                                                                                  BinnedVariables = cms.PSet( npf15PU = cms.vdouble(-0.5,0.5,1.5,2.5,3.5,4.5),
                                                                                                                              ),
                                                                                                  BinToPDFmap = cms.vstring("gaussPlusLinear")
                                                                                                  ),
                                                                            npf15PU_wp80 = cms.PSet(EfficiencyCategoryAndState = cms.vstring("passWP80","pass"),
                                                                                                  UnbinnedVariables = cms.vstring("mass"),
                                                                                                  BinnedVariables = cms.PSet( npf15PU = cms.vdouble(-0.5,0.5,1.5,2.5,3.5,4.5),
                                                                                                                              pt = cms.vdouble(20,100),
                                                                                                                              ),
